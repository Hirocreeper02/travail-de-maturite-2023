...
def creationExemple():
    ...
    provinces.index["Bâtiment A"].comtes.append(comtes.Comte("A11",factions.index["Profs d'Informatique"],ressources.index["Fer"], 100,[],[0,0,0,0]))
    provinces.index["Bâtiment A"].comtes.append(comtes.Comte("A12",factions.index["Profs d'Informatique"],ressources.index["Nourriture"], 100,[],[0,0,0,0]))
    provinces.index["Bâtiment A"].comtes.append(comtes.Comte("A13",factions.index["Profs d'Informatique"],ressources.index["Fer"], 100,[],[0,0,0,0]))
    provinces.index["Bâtiment A"].comtes.append(comtes.Comte("A14",factions.index["Profs d'Informatique"],ressources.index["Bijouterie"], 100,[],[0,0,0,0]))
    provinces.index["Bâtiment A"].comtes.append(comtes.Comte("A15",factions.index["Profs d'Informatique"],ressources.index["Ficelle"], 100,[],[0,0,0,0]))
    provinces.index["Bâtiment A"].comtes.append(comtes.Comte("A16",factions.index["Profs d'Informatique"],ressources.index["Or"], 100,[],[0,0,0,0]))
    provinces.index["Bâtiment A"].comtes.append(comtes.Comte("A17",factions.index["Profs d'Informatique"],ressources.index["Armes"], 100,[],[0,0,0,0]))
    provinces.index["Bâtiment A"].comtes.append(comtes.Comte("A18",factions.index["Profs d'Informatique"],ressources.index["Nourriture"], 100,[],[0,0,0,0]))
    provinces.index["Bâtiment A"].comtes.append(comtes.Comte("A1T",factions.index["Profs d'Informatique"],ressources.index["Nourriture"], 100,[],[0,0,0,0]))

    provinces.liste.append(provinces.Province("Bâtiment B",factions.index["Profs de MEP"]))

    provinces.index["Bâtiment B"].comtes.append(comtes.Comte("B41",factions.index["Profs de MEP"],ressources.index["Fer"], 100,[],[0,0,0,0]))
    provinces.index["Bâtiment B"].comtes.append(comtes.Comte("B42",factions.index["Profs de MEP"],ressources.index["Laine"], 100,[],[0,0,0,0]))
    provinces.index["Bâtiment B"].comtes.append(comtes.Comte("B44",factions.index["Profs de MEP"],ressources.index["Armes"], 100,[],[0,0,0,0]))
    provinces.index["Bâtiment B"].comtes.append(comtes.Comte("B45",factions.index["Profs de MEP"],ressources.index["Or"], 100,[],[0,0,0,0]))
    provinces.index["Bâtiment B"].comtes.append(comtes.Comte("Local",factions.index["Profs de MEP"],ressources.index["Nourriture"], 100,[],[0,0,0,0]))
    provinces.index["Bâtiment B"].comtes.append(comtes.Comte("WC",factions.index["Profs de MEP"],ressources.index["Diamant"], 100,[],[0,0,0,0]))

    provinces.liste.append(provinces.Province("Bâtiment C",factions.index["Profs de Français"]))

    provinces.index["Bâtiment C"].comtes.append(comtes.Comte("C21",factions.index["Profs de Français"],ressources.index["Laine"], 100,[],[0,0,0,0]))
    provinces.index["Bâtiment C"].comtes.append(comtes.Comte("C22",factions.index["Profs de Français"],ressources.index["Armes"], 100,[],[0,0,0,0]))
    provinces.index["Bâtiment C"].comtes.append(comtes.Comte("C23",factions.index["Profs de Français"],ressources.index["Fer"], 100,[],[0,0,0,0]))
    provinces.index["Bâtiment C"].comtes.append(comtes.Comte("C24",factions.index["Profs de Français"],ressources.index["Nourriture"], 100,[],[0,0,0,0]))
    provinces.index["Bâtiment C"].comtes.append(comtes.Comte("C25",factions.index["Profs de Français"],ressources.index["Habits"], 100,[],[0,0,0,0]))
    provinces.index["Bâtiment C"].comtes.append(comtes.Comte("Salle des Maîtres",factions.index["Profs de Français"],ressources.index["Ficelle"], 100,[],[0,0,0,0]))

    provinces.liste.append(provinces.Province("Bâtiment de Sport",factions.index["Profs de Sport"]))

    provinces.index["Bâtiment de Sport"].comtes.append(comtes.Comte("Salle des Profs",factions.index["Profs de Sport"],ressources.index["Diamant"], 100,[],[0,0,0,0]))
    provinces.index["Bâtiment de Sport"].comtes.append(comtes.Comte("Salle I",factions.index["Profs de Sport"],ressources.index["Habits"], 100,[],[0,0,0,0]))
    provinces.index["Bâtiment de Sport"].comtes.append(comtes.Comte("Salle II",factions.index["Profs de Sport"],ressources.index["Nourriture"], 100,[],[0,0,0,0]))
